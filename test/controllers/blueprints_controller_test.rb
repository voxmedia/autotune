...
class BlueprintsControllerTest < ActionController::TestCase
  ...
  test 'listing blueprints' do
    ...
    assert_equal blueprints(:example).id, decoded_response.first['id']
  end
  ...
  test 'show blueprint' do
    ...
    get :show, :id => blueprints(:example).id
    assert_response :success
    assert_blueprint_data!
    assert_equal blueprints(:example).id, decoded_response['id']
  end
  ...
  test 'delete blueprint' do
    ...
    delete :destroy, :id => blueprints(:example).id

...
},{"./router":3,"backbone":11,"bootstrap":12,"jquery":13}],2:[function(require,module,exports){
"use strict";
...
},{"backbone":11,"underscore":14}],3:[function(require,module,exports){
"use strict";
...
},{"./models":2,"./views":9,"backbone":11,"jquery":13}],4:[function(require,module,exports){
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<ol class="breadcrumb">\n  <li class="active">Blueprints</li>\n</ol>\n<button id="new-blueprint" class="btn btn-primary" data-toggle="modal" data-target="#newBlueprintModal">\n  New blueprint\n</button>\n';
 _.each(models, function(item) { 
__p+='\n  <div class="media">\n    <a class="pull-left" href="/blueprints/'+
((__t=( item.attributes.name ))==null?'':__t)+
'/">\n      <img class="media-object" src="/blueprints/'+
((__t=( item.attributes.name ))==null?'':__t)+
'/thumb"\n           alt="'+
...
with(obj||{}){
__p+='<ol class="breadcrumb">\n  <li><a href="/">Blueprints</a></li>\n  <li><a href="/blueprints/'+
((__t=( blueprint.attributes.name ))==null?'':__t)+
'/">'+
((__t=( blueprint.attributes.name ))==null?'':__t)+
'</a></li>\n  <li><a href="/blueprints/'+
((__t=( blueprint.attributes.name ))==null?'':__t)+
...
'/">'+
((__t=( blueprint.attributes.name ))==null?'':__t)+
'</a></li>\n  <li class="active">Builds</li>\n</ol>\n<a id="new-build" class="btn btn-primary"\n   href="/blueprints/'+
((__t=( blueprint.attributes.name ))==null?'':__t)+
'/builds/new">New build</a>\n\n';
 _.each(models, function(item) { 
__p+='\n  <div class="media">\n    <div class="media-body">\n      <h4 class="media-heading">\n        '+
((__t=( item.attributes.name ))==null?'':__t)+
'\n      <p>'+
...
},{"./models":2,"./templates/blueprint.ejs":4,"./templates/blueprint_list.ejs":5,"./templates/build.ejs":6,"./templates/build_edit.ejs":7,"./templates/build_list.ejs":8,"./views/BaseView":10,"backbone":11,"jquery":13,"underscore":14}],10:[function(require,module,exports){
"use strict";
...
},{"../models":2,"backbone":11,"jquery":13,"underscore":14}],11:[function(require,module,exports){
//     Backbone.js 1.1.2

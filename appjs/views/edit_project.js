      ...
      .then(function() {
        ...
        if(view.model.hasPreviewType('live')){
          if(view.model.getConfig().spreadsheet_template){
            $( "input[name='google_doc_url']" ).after('<button type="button" id="spreadsheet-button" data-hook="create-spreadsheet" class="btn btn-default">Create new empty spreadsheet</button>');
          }
        }
        view.getTwitterCount();
      }).catch(function(err) {
